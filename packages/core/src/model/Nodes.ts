...
import { arbitrateChatMessagesNode } from './nodes/ArbitrateChatMessagesNode.js';
...
export * from './nodes/ArbitrateChatMessagesNode.js';
...
export const registerBuiltInNodes = (registry: NodeRegistration) => {
  return registry
    ...
    .register(arbitrateChatMessagesNode)
